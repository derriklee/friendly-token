...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 500000000000 * 10**18;
    ...
    constructor (address cOwner, address developerWallet) Ownable(cOwner) {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        takeTransactionFee(address(_developerWallet), tDeveloper, currentRate);
    ...
    function removeAllFee() private {
        if (_taxFee == 0 && _liquidityFee == 0 && _developerFee == 0) return;
